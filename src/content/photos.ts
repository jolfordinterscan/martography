...
export const photos: Photo[] = [
  ...
  ...[
    ...
    [
      ...
      "Painted Bunting perched among green leaves",
      "painted-bunting-green-leaves.jpg",
      "species-painted-bunting",
      "birds",
    ],
    ["tarantula", "Tarantula", "tarantula.jpg", "species-tarantula", "mammals"],
    [
      "wood-duck-portrait",
      "Wood Duck frontal portrait",
    ...
    ["bald-eagle-pair", "Bald Eagle pair", "bald-eagle-pair.jpg", "species-bald-eagle", "birds"],
    [
  ...
  ].map(([slug, alt, missingImageFilename, speciesId, category]) => ({
    ...base,
    id: `photo-${slug}`,
    slug,
    title: "Title Pending Artist Approval",
